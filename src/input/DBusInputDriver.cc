...
bool DBusInputDriver::open()
{
	...
	connect(iface, SIGNAL(rotate(double, double, double)), this,
					SLOT(rotate(double, double, double)));
	connect(iface, SIGNAL(rotateTo(double, double, double)), this,
					SLOT(rotateTo(double, double, double)));
	connect(iface, SIGNAL(translate(double, double, double)), this,
					SLOT(translate(double, double, double)));
	connect(iface, SIGNAL(translateTo(double, double, double)), this,
					SLOT(translateTo(double, double, double)));
