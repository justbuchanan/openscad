...
public:
	...
	void deliver(InputEventHandler *receiver) { receiver->onAxisChanged(this); }
};
...
public:
	...
	void deliver(InputEventHandler *receiver) { receiver->onButtonChanged(this); }
};
...
public:
	...
	void deliver(InputEventHandler *receiver) { receiver->onTranslateEvent(this); }
};
...
public:
	...
	void deliver(InputEventHandler *receiver) { receiver->onRotateEvent(this); }
};
...
public:
	...
	void deliver(InputEventHandler *receiver) { receiver->onZoomEvent(this); }
};
...
public:
	...
	InputEventAction(const std::string action, const bool activeOnly = true)
		: InputEvent(activeOnly), action(action)
	{
	}

	void deliver(InputEventHandler *receiver) { receiver->onActionEvent(this); }
};
