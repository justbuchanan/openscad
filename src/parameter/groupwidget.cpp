...
GroupWidget::GroupWidget(bool &show, const QString &title, const int animationDuration,
												 QWidget *parent)
...
void GroupWidget::onclicked(const bool /*checked*/)
{
	...
	toggleAnimation.setDirection(toggleButton.isChecked() ? QAbstractAnimation::Forward
...
void GroupWidget::setContentLayout(QLayout &contentLayout)
{
	...
	for (int i = 0; i < toggleAnimation.animationCount() - 1; ++i) {
		QPropertyAnimation *GroupWidgetAnimation =
