...
// NDEBUG must be disabled when including CGAL headers, otherwise CGAL
// assertions will not be thrown, causing OpenSCAD's CGAL error checking to
// fail. To be on the safe side, this has to be done when including any CGAL
// header file.
...
typedef CGAL::Iso_rectangle_2<CGAL::Simple_cartesian<NT2>>
    CGAL_Iso_rectangle_2e;
