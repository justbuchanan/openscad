...
void CGALRenderer::draw(bool showfaces, bool showedges) const {
    ...
    if (this->polyset) {
        ...
        if (this->polyset->getDimension() == 2) {
            ...
            // FIXME:		const QColor &col =
            // Preferences::inst()->color(Preferences::CGAL_FACE_2D_COLOR);
            ...
            glLineWidth(2);
            // FIXME:		const QColor &col2 =
            // Preferences::inst()->color(Preferences::CGAL_EDGE_2D_COLOR);
            ...
            this->polyset->render_surface(CSGMODE_NORMAL,
