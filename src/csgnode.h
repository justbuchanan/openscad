...
public:
    ...
    static shared_ptr<CSGNode> createCSGNode(OpenSCADOperator type,
                                             shared_ptr<CSGNode> left,
                                             shared_ptr<CSGNode> right);
    static shared_ptr<CSGNode> createCSGNode(OpenSCADOperator type,
                                             CSGNode *left, CSGNode *right) {
        return createCSGNode(type, shared_ptr<CSGNode>(left),
                             shared_ptr<CSGNode>(right));
    }

private:
    CSGOperation(OpenSCADOperator type, shared_ptr<CSGNode> left,
                 shared_ptr<CSGNode> right);
...
public:
    CSGLeaf(const shared_ptr<const class Geometry> &geom,
...
public:
    CSGChainObject(const shared_ptr<CSGLeaf> &leaf,
...
public:
    ...
    void import(shared_ptr<CSGNode> csgtree,
