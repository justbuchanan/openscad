...
void progress_report_prep(class AbstractNode *root,
													void (*f)(const class AbstractNode *node, void *vp, int mark), void *vp);
...
public:
	...
	const std::vector<AbstractNode *> &getChildren() const { return this->children; }
