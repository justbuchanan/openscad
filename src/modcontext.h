...
/*!
        ...
        NB! every .scad file defines a FileModule holding the contents of the
   file.
*/
class ModuleContext : public Context {
public:
    ModuleContext(const Context *parent = nullptr,
                  const EvalContext *evalctx = nullptr);
    ...
    // FIXME: Points to the eval context for the call to this module. Not sure
    // where it belongs
