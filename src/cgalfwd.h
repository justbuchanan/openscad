...
class HDS_items;
template <class A, typename Items_, typename Mark_>
class Nef_polyhedron_2;
}  // namespace CGAL
typedef CGAL::Gmpq NT;
typedef CGAL::Extended_cartesian<NT> CGAL_Kernel2;
typedef CGAL::Nef_polyhedron_2<CGAL_Kernel2, CGAL::HDS_items, bool>
...
typedef CGAL::Nef_polyhedron_3<CGAL_Kernel3, CGAL::SNC_indexed_items, bool>
...
template <class PolyhedronTraits_3, class PolyhedronItems_3, class T_HDS,
          class Alloc>
class Polyhedron_3;
}
typedef CGAL::Polyhedron_3<
    CGAL_Kernel3, CGAL::Polyhedron_items_3,
    CGAL::HalfedgeDS_default<CGAL_Kernel3, CGAL::HalfedgeDS_items_2,
                             CGAL_ALLOCATOR(int)>,
    CGAL_ALLOCATOR(int)>
    CGAL_Polyhedron;
