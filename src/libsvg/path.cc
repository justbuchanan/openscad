...
path::path(const path& orig) : shape(orig) { data = orig.data; }
...
void path::set_attrs(attr_map_t& attrs) {
        ...
        switch (cmd) {
            ...
            case 'A':
                ...
                switch (point) {
                    ...
                    case 6:
                        yy = cmd == 'a' ? y + p : p;
                        arc_to(path_list.back(), x, y, rx, ry, xx, yy, angle,
                               large, sweep);
                        x = xx;
                        y = yy;
                        point = -1;
            ...
            case 'C':
                switch (point) {
                    ...
                    case 5:
                        ...
                        cx2 = cmd == 'c' ? x + cx2 : cx2;
                        cy2 = cmd == 'c' ? y + cy2 : cy2;
                        curve_to(path_list.back(), x, y, cx1, cy1, cx2, cy2, xx,
                                 yy);
                        x = xx;
                        y = yy;
                        point = -1;
                    ...
                    case 0:
                        if (last_cmd_cubic_bezier) {
                            ...
                            Eigen::Vector2d new_control_point =
                                current_point +
                                (current_point - old_control_point);
...
bool path::is_open_path(path_t& path) {
