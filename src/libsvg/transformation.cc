...
transformation::transformation(const std::string op, const std::string name)
    : op(op), name(name) {}

transformation::~transformation() {}

const std::string& transformation::get_op() { return op; }

const std::string& transformation::get_name() { return name; }
...
const std::string transformation::get_args() {
